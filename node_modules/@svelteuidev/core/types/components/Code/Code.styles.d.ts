import type { SvelteUIColor, DefaultProps } from '../../styles';
...
declare const _default: (params?: CodeStyleParams, options?: import("../../styles/engine/create-styles").UseStylesOptions<"copy" | "block" | "root">) => {
    cx: (...args: import("../../styles/engine/css").ArgumentArray) => string;
    theme: import("../../styles").SvelteUITheme;
    classes: Record<"copy" | "block" | "root", string>;
