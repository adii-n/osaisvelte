<script data-manual>// option 'data-manual' needed to use Prism with no automatic highlight on import
...
export let className = '', override = {}, size = 'md', code = '', language = 'javascript', lineNumbers = false, highlightLines = null, normalizeWhiteSpace = true, normalizeWhiteSpaceConfig = config, copy = true, copyTimeout = 3000;
...
$: prismClasses = `language-${language} ${normalizeWhiteSpace ? '' : 'no-whitespace-normalization'}`;
$: PrismCss = css({
    color: '$gray900',
